firebase.initializeApp({
    //messagingSenderId: '355859698902'
    messagingSenderId: '885365714308'
});
...
function setNotificationDemoBody() {
    if (input_body.val().search(/^Ваша очередь подошла \d\d:\d\d$/i) !== -1) {
        var now = new Date();
        input_body.val('Ваша очередь подошла ' + now.getHours() + ':' + addZero(now.getMinutes()));
    } else {
...
$( document ).ready(function() {
    ...
    sendNotificationByToken(notification, token);
    */
});
...
function sendNotification(notification) {
	//var key = 'AAAAUtrkFNY:APA91bF2gFUIjsQXndZoersAA-d6tRjJtXOFeSp1_Z0vY5SOhlbf7Kd9FMahdw5wH2q5Ht36gb30PmA4fc1kUVm6TcUXSbPvQ6S3AjHds9fOhM-5yeZ9O5TUN-ubHamJJ7YPjt7qheCe';
    var key = 'AAAAziPorYQ:APA91bF7cG2OpliRZK9tiua-j2ziaJohyxKamabj-o1Bu-VPaLfg-XOO6dFitGc-Ivaaal4CNuQD10W9XYWs9UU-8mW9tGgADn5cuetf5MOvdRvOqIoH5CMEp8y87PTw2vB44C3kccRh';
...
function sendNotificationByToken(notification, token) {
	var key = 'AAAAziPorYQ:APA91bF7cG2OpliRZK9tiua-j2ziaJohyxKamabj-o1Bu-VPaLfg-XOO6dFitGc-Ivaaal4CNuQD10W9XYWs9UU-8mW9tGgADn5cuetf5MOvdRvOqIoH5CMEp8y87PTw2vB44C3kccRh';
